    ...
    <LayoutAuthenticated>
        ...
        <SectionMain>
            <SectionTitleLineWithButton :icon="mdiServer" title="Add Complementary Social Service" main>
                <BaseButton :route-name="route('admin.organization.show', props.organization_id)" :icon="mdiArrowLeftBoldOutline" label="Back"
                    color="white" rounded-full small />
            </SectionTitleLineWithButton>
            <CardBox form @submit.prevent="form.post(route('admin.organization.storeService'))">
