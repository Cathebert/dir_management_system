...
<template>
    <LayoutAuthenticated>
        ...
        <Head title="District"/>
        <SectionMain>
            <SectionTitleLineWithButton :icon="mdiEarth" title="District" main>
                <BaseButton v-if="can.delete" :route-name="route('admin.district.create')" :icon="mdiPlus" label="Add"
            ...
            <CardBox class="mb-6" has-table>
                <form @submit.prevent="form.get(route('admin.district.index'))">
                    <div class="py-2 flex">
                        <div class="flex pl-4">
